...
public:
  positionTask(const std::string & endEffectorName,
  ...
  : metaManipulatorTask(endEffectorName, desiredPosition, skelPtr, configurationDataTree, weight, Kv, Kp, selectionV)
  {
